...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinition.is_recaptcha'
        db.add_column('form_designer_formdefinition', 'is_recaptcha', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormDefinition.is_recaptcha'
        db.delete_column('form_designer_formdefinition', 'is_recaptcha')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_recaptcha': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
